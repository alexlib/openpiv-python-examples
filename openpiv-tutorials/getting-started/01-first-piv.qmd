...
# Define PIV parameters (OpenPIV 0.26.0: `scipy.fft` is default; Rust optional)

> **Requires `openpiv>=0.26.0`** — `scipy.fft` backend is now default (2-3x faster). For extra speed install the Rust extension `pip install openpiv[rust]` and use `backend="rust"` or `"auto"`.
...
u0, v0, sig2noise = pyprocess.extended_search_area_piv(
    ...
    # backend="scipy"  # default since 0.26.0: scipy.fft; use "rust" or "auto" for Rust acceleration
)
